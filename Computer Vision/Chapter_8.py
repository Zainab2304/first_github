# Reading a video and converting ait to gray and binary and saving it 
...
out = cv.VideoWriter("resources/Out_video.mp4",cv.VideoWriter_fourcc(*"VIDX"), 20, (frame_width, frame_height), isColor=False )
...
while (True):
    ...
    # Agr sirg gray me chahiey to jha jha binayry likha wha gray frame likh do 
